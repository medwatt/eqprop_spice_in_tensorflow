...
if __name__ == "__main__":
    ...
    model = [
        ...
        Conv2DLayer(10, kernel_size=(5, 5), strides=5, padding="valid", g_range=[1e-7, 1e-5], trainable=True, lr=1e-6, diodes_enabled=True, diode_params=diode_params, dtype=TF_DTYPE),
    ...
    ep.train(dataset, epochs=200, free_iter=100, nudge_iter=50, tolerance=1e-6)
